...
public class Fence2Tests {
    ...
    public void someTests() {
        ...
        assertTrue(validationNameHaveNumbers(fence.setName2("Izabel123")));

        // Testar o nome da com apenas letras
        assertFalse(validationNameHaveNumbers(fence.setName2("Izabel")));
